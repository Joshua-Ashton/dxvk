...
namespace dxvk {
  ...
  size_t D3D10StateDescHash::operator () (
    const D3D10_BLEND_DESC1& desc) const {
    DxvkHashState hash;
  ...
  size_t D3D10StateDescHash::operator () (
    const D3D10_DEPTH_STENCILOP_DESC& desc) const {
    DxvkHashState hash;
  ...
  size_t D3D10StateDescHash::operator () (
    const D3D10_RASTERIZER_DESC& desc) const {
  ...
  size_t D3D10StateDescHash::operator () (
    const D3D10_RENDER_TARGET_BLEND_DESC1& desc) const {
    DxvkHashState hash;
  ...
  size_t D3D10StateDescHash::operator () (
    const D3D10_SAMPLER_DESC& desc) const {
    std::hash<float> fhash;
  ...
  bool D3D10StateDescEqual::operator () (
    const D3D10_BLEND_DESC1& a,
    const D3D10_BLEND_DESC1& b) const {
  ...
  bool D3D10StateDescEqual::operator () (
    const D3D10_DEPTH_STENCILOP_DESC& a,
    const D3D10_DEPTH_STENCILOP_DESC& b) const {
  ...
  bool D3D10StateDescEqual::operator () (
    ...
    const D3D10_RASTERIZER_DESC& b) const {
  ...
  bool D3D10StateDescEqual::operator () (
    const D3D10_RENDER_TARGET_BLEND_DESC1& a,
    const D3D10_RENDER_TARGET_BLEND_DESC1& b) const {
