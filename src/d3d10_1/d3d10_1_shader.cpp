...
namespace dxvk {
  ...
  std::string D3D10ShaderKey::GetName() const {
  ...
  size_t D3D10ShaderKey::GetHash() const {
  ...
  D3D10ShaderModule:: D3D10ShaderModule() { }
  D3D10ShaderModule::~D3D10ShaderModule() { }
  ...
  D3D10ShaderModuleSet:: D3D10ShaderModuleSet() { }
  D3D10ShaderModuleSet::~D3D10ShaderModuleSet() { }
  
  
  D3D10ShaderModule D3D10ShaderModuleSet::GetShaderModule(
    const DxbcOptions*    pDxbcOptions,
    const void*           pShaderBytecode,
          size_t          BytecodeLength,
          DxbcProgramType ProgramType) {
    // Compute the shader's unique key so that we can perform a lookup
    D3D10ShaderKey key(ProgramType, pShaderBytecode, BytecodeLength);
    ...
    D3D10ShaderModule module(&key, pDxbcOptions, pShaderBytecode, BytecodeLength);
